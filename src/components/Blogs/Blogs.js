    ...
    return (
        ...
        <h2>How React Context API Works?</h2>
           ...
           <h2>Inline vs Block vs Inline-Block ?</h2>
            <p>
                <p>Inline Elements <br></br> Inline elements don’t start on a new line, they appear on the same line as the content and tags beside them. Some examples of inline elements are span , strong, and img tags.</p>

                <p>Block Elements <br></br>A block element always starts on a new line, and fills up the horizontal space left and right on the web page. You can add margins and padding on all four sides of any block element — top, right, left, and bottom.</p>

                <p>Inline-Block Elements <br></br> Inline-block elements are similar to inline elements, except they can have padding and margins added on all four sides. You’ll have to declare display: inline-block in your CSS code.</p>
            </p>
           </div>
        </div>
    );
